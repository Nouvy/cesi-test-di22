...
return [
    ...
    */
    ...
    | convention "attribute.rule" pour nommer les lignes. Cela permet de spécifier rapidement un message personnalisé spécifique pour une règle d'attribut donnée.
    |
    */
    ...
    | par quelque chose de plus lisible par le lecteur comme "Adresse e-mail" au lieu de "email". Cela nous aide simplement à rendre notre message plus expressif.
    |
    */
